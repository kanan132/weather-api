class CurrentWeather {
									...
									<div class="tab-pane" id="tab2">
										...
										<div class="city-selected">
											<article>
												...
												<div class="info">
													<div class="city"><span></span> ${data.city.name}</div>
													<div class="night">${timestamp_to_date(data.list[8].dt)}</div>
							
													<div class="temp">${Math.round(data.list[8].main.temp - 273.15)}°C</div>
													...
													<div class="wind">
														...
														<span>${data.list[8].wind.speed} km/h</span>
													</div>
												</div>
									...
									<div class="tab-pane" id="tab3">
										...
										<div class="city-selected">
											<article>
												...
												<div class="info">
													<div class="city"><span></span> ${data.city.name}</div>
													<div class="night">${timestamp_to_date(data.list[16].dt)}</div>
							
													<div class="temp">${Math.round(data.list[16].main.temp - 273.15)}°C</div>
													...
													<div class="wind">
														...
														<span>${data.list[16].wind.speed} km/h</span>
													</div>
												</div>
	...
	/*	render_today(data){
		...
		document.querySelector(".first").addEventListener('click', (e) => {
				...
				document.querySelector("#main").innerHTML = `<div id="card" class="weater">
				<div class="city-selected">
					<article>
				...
				<div class="days">
					<div class="row row-no-gutter">
						<div class="col-md-4">
							<div class="first day">
								<h2 class="daily">Today</h2>
									<i class="fas fa-temperature-high" id="icon-day"></i>
							</div>
						</div>
	
						<div class="col-md-4">
							<div class="second day">
								<h2 class="daily">Tomorrow</h2>
									<i class="fas fa-temperature-high" id="icon-day"></i>
							</div>
						</div>
						...
						<div class="col-md-4">
							<div class="third day">
								<h2 class="daily">After tomorrow</h2>
									<i class="fas fa-temperature-high" id="icon-day"></i>
							</div>
						</div>
